...
public final class UnixDomainSocketClientForwardingFactory
	...
	public ForwardingChannelFactory<SshClientContext> createChannelFactory(String hostToConnect, int portToConnect) {
		return new UnixDomainSocketClientLocalForwardingChannelFactoryImpl(ForwardingRequestBuilder.create().
			withDestinationPath(hostToConnect).
			build()
		);
	}

	@Override
	public ForwardingChannelFactory<SshClientContext> createChannelFactory(ForwardingRequest request) {
		return new UnixDomainSocketClientLocalForwardingChannelFactoryImpl(request);
	}
