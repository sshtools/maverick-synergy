...
public class UnixDomainSockets {
	...
	public static final String STREAM_LOCAL_FORWARD_CHANNEL = "streamlocal-forward@openssh.com";
	public static final String CANCEL_STREAM_LOCAL_FORWARD_CHANNEL = "cancel-streamlocal-forward@openssh.com";
