...
public class SftpStatusEventException extends EventException {

	private static final long serialVersionUID = -1620874154937769113L;
	...
	public SftpStatusEventException(int status, String msg) {
