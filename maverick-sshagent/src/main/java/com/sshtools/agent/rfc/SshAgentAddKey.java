...
public class SshAgentAddKey extends AgentMessage {
    ...
    public void constructByteArray(ByteArrayWriter baw)
        ...
        try {
        	...
        	baw.writeBinaryString(SshPrivateKeyFileFactory.create(keyPair,null,"Test" ,SshPrivateKeyFileFactory.SSHTOOLS_FORMAT).getFormattedKey()); //changed by Aruna, need to check with Lee
